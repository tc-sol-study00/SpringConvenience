 ...
 */
@Component
public class ChumonImpl implements Chumon {
	...
	public void setChumonJisseki(ChumonJisseki inChumonJisseki) {
		this.chumonJisseki = inChumonJisseki;
	}

	// 仕入先マスタレポジトリ
	private final ShiireSakiMasterRepository shiireSakiMasterRepository;

	// 仕入マスタレポジトリ
	private final ShiireMasterRepository shiireMasterRepository;

	// 注文実績レポジトリ
	private final ChumonJissekiRepository chumonJissekiRepository;

	// DI注入
	public ChumonImpl(ShiireSakiMasterRepository inShiireSakiMasterRepository,
			ShiireMasterRepository inShiireMasterRepository, ChumonJissekiRepository inChumonJissekiRepository) {
		// 仕入先マスタレポジトリ
		this.shiireSakiMasterRepository = inShiireSakiMasterRepository;
		// 仕入マスタレポジトリ
		this.shiireMasterRepository = inShiireMasterRepository;
		// 注文実績レポジトリ
		this.chumonJissekiRepository = inChumonJissekiRepository;
	}
